...
- Create: `assets/ai/aigc-campus-film.jpg`
- Create: `assets/ai/aigc-event-promo.jpg`
...
```text
assets/ai/aigc-campus-film.jpg
assets/ai/aigc-event-promo.jpg
```

两支视频均为横屏，封面保持 `16:9`，不下载或保存视频文件。

- [x] **Step 2: 替换第二、第三张项目卡片并添加复用弹窗**
...
- [x] **Step 4: 实现按需 iframe、关闭清理和键盘操作**
